export const postpartumAnxietyContent = {
  header: {
    category: "Recovery",
  ...
  intro: {
    p1: "She is checking the baby monitor for the fifth time in an hour. The baby is breathing. She can see it on the screen. She knows the baby is breathing. But she checks again anyway. And then again. The worry is not proportionate to the threat — but it does not feel that way. It feels like vigilance. It feels like good mothering. That is exactly what makes postpartum anxiety so hard to recognise.",
    p2: "Postpartum anxiety is one of the most common postpartum mental health conditions — affecting an estimated 15 to 20 per cent of new mothers — yet it is consistently underdiagnosed because it does not look like distress from the outside. It looks like a devoted, careful mother.",
    p3: "This guide covers what postpartum anxiety actually is, how it differs from postpartum depression, what the symptoms feel like from the inside, and how to access effective help. The most important thing to know before you read on: postpartum anxiety is treatable. You do not have to white-knuckle your way through the first year.",
  },

  featuredSnippet: {
    title: "The short answer:",
    content: "Postpartum anxiety is persistent, excessive worry that does not ease with reassurance and interferes with daily life. It is not the same as postpartum depression — though both can occur together. It is very common, often undiagnosed, and highly treatable with therapy, medication, or both. It is not a reflection of how much you love your baby.",
  },

  whatIs: {
    title: "What Is Postpartum Anxiety?",
    p1: "Postpartum anxiety is not the normal worry of new parenthood. Every new mother worries — about sleep, about feeding, about whether the baby is too cold or too warm. That is expected, and it is proportionate. <strong>Postpartum anxiety disorder</strong> is something different: persistent, disproportionate fear that does not respond to reassurance, that takes over your thinking, and that interferes with your ability to function, sleep, or rest even when the situation is safe.",
    p2: "It exists on a spectrum. Generalised postpartum anxiety is the most common presentation — constant background worry that never fully switches off. <strong>Postpartum panic disorder</strong> involves discrete episodes of intense physical fear: racing heart, chest tightness, dizziness, the overwhelming sense that something terrible is about to happen. <strong>Postpartum OCD</strong> involves intrusive, unwanted thoughts — often about harm coming to the baby — paired with compulsive behaviours designed to neutralise the fear. These are all forms of <strong>perinatal anxiety</strong>, a term that encompasses anxiety occurring during pregnancy and the postpartum period.",
    p3: "The prevalence is higher than most people realise. Studies consistently report that 15 to 20 per cent of new mothers experience clinically significant postpartum anxiety, with some estimates reaching as high as 34 per cent when sub-threshold symptoms are included. It can begin during pregnancy, in the immediate postpartum period, or any time within the first year after birth. Many cases go unidentified because the mother is high-functioning, because anxiety looks like dedication, and because the standard screening tools used at postnatal appointments are not well calibrated to detect it.",
  },

  vsDepression: {
    title: "Postpartum Anxiety vs Postpartum Depression — The Key Differences",
    p1: "This is the distinction that matters most, and it is the one that is most often missed. <a href='/blog/postpartum-depression-vs-baby-blues/' class='text-[#E8A0A8] hover:underline'>Postpartum depression</a> is characterised by hypoactivation — low mood, withdrawal, emotional numbness, loss of pleasure, the feeling of being crushed under a weight. Postpartum anxiety is characterised by hyperactivation — racing thoughts, hypervigilance, an inability to rest, physical tension, and a nervous system that cannot come down from high alert.",
    p2: "The clearest way to understand the difference: a mother with postpartum depression often cannot get out of bed. A mother with postpartum anxiety often cannot sit down. She is doing everything, checking everything, researching everything — and still cannot shake the feeling that something terrible is about to happen. Both states are exhausting. Both are serious. Both are treatable. But they respond to slightly different approaches, which is why accurate identification matters.",
    ...
    tableRows: [
      { feature: "Core feeling", depression: "Persistent sadness", anxiety: "Constant worry" },
      { feature: "Energy", depression: "Exhaustion, withdrawal", anxiety: "Restlessness, can't settle" },
      { feature: "Sleep", depression: "Sleeping too much or unable to sleep", anxiety: "Can't sleep even when baby sleeps" },
      { feature: "Thoughts", depression: "Hopelessness, numbness", anxiety: "Racing thoughts, worst-case scenarios" },
      { feature: "Physical", depression: "Heaviness, fatigue", anxiety: "Racing heart, chest tightness" },
    ],
  },

  symptoms: {
    title: "Postpartum Anxiety Symptoms — What It Actually Feels Like",
    p1: "The <strong>emotional</strong> picture of postpartum anxiety centres on worry that is both persistent and disproportionate. It is the constant low hum of dread that nothing is quite safe. It is the inability to feel genuinely reassured even when the midwife has checked the baby and told you everything is fine. Catastrophic thinking — the brain's automatic leap to the worst-case outcome — is the default mode: what if something happens while she is sleeping, what if I did not sterilise that correctly, what if he stops breathing and I do not hear it in time. The thought loop does not resolve; it only pauses briefly before starting again.",
    p2: "The <strong>physical</strong> symptoms of postpartum anxiety are real and often alarming in themselves. A racing heart, tightness in the chest, shallow breathing, nausea, dizziness, and persistent muscle tension — particularly in the shoulders, jaw, and neck — are all common. Many mothers end up in A&amp;E convinced they are having a cardiac event before postpartum anxiety is even considered. Chronic insomnia that persists even when the baby is settled and sleeping is one of the most reliable physical markers: when your nervous system cannot regulate itself, it refuses to let you rest.",
    p3: "<strong>Intrusive thoughts</strong> — unwanted, distressing mental images or scenarios, often involving harm to the baby — deserve their own paragraph because they are so widely misunderstood. These thoughts arrive without warning and cause immediate horror. Having them does not mean you will act on them. It is precisely the horror — the revulsion, the desperate attempt to push the thought away — that distinguishes intrusive thoughts driven by anxiety from any form of harmful intent. They are a symptom of an overactivated threat-detection system, not a window into your character or your intentions.",
    p4: "<strong>Behaviourally</strong>, postpartum anxiety often shows up as hypervigilance and compulsive checking — the monitor, the breathing, the car seat buckle, the temperature. It also presents as avoidance: refusing to go anywhere with the baby because something might go wrong, or the opposite, refusing to leave the baby with anyone else because only you can keep them safe. Difficulty delegating care — even to a trusted partner — is one of the most commonly reported features, and one that places enormous strain on relationships.",
  },

  warningBox: {
    title: "Signs it is time to seek professional support today",
    items: [
