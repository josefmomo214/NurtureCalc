...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Postpartum Recovery Articles — Honest Guides for New Mothers | NurtureCalc",
    description:
      "Science-based guides to postpartum recovery — C-section healing, pelvic floor, hair loss, body changes, mental health and more. Written for real mothers.",
    alternates: {
      canonical: "/blog/recovery",
    },
    openGraph: {
      url: "https://nurturecalc.com/blog/recovery",
      type: "article",
      title: "Postpartum Recovery Articles — Honest Guides for New Mothers | NurtureCalc",
      description:
        "Science-based guides to postpartum recovery — C-section healing, pelvic floor, hair loss, body changes, mental health and more. Written for real mothers.",
...
const filtered = blogPosts.filter((p) => p.category === "Recovery");

export default function RecoveryCategory() {
  return (
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                item: "https://nurturecalc.com/blog/recovery",
              },
            ],
          }),
        }}
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full py-16 px-6">
        <header className="space-y-4 border-b border-[#E8A0A8]/20 pb-12 mb-12">
          ...
          <p className="text-[#E8A0A8] text-xl font-serif italic">
            Honest, science-based guides to healing your body and mind after birth.
          </p>
        </header>
        ...
        <div className="mt-12 bg-[#FFFDF9] rounded-2xl p-6 shadow-sm">
          <h3 className="text-2xl font-serif text-[#3D2C2C] mb-3">
            Unsure where you are in your recovery?
          </h3>
          <p className="text-[#3D2C2C]/70 leading-relaxed mb-6">
            The Pelvic Floor Recovery Estimator gives you a personalised assessment of your
            current stage and gentle next steps.
          </p>
          <Link
