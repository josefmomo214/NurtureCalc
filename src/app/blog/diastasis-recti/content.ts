export const diastasisRectiContent = {
  header: {
    category: "Recovery",
  ...
  intro: {
    direct: "Diastasis recti is a separation of the abdominal muscles along the midline that affects up to **60% of pregnant women**. It can partially heal on its own — most women see natural narrowing in the first **6–8 weeks postpartum** as the uterus returns to size. However, significant gaps and weakened tissue tension rarely resolve fully without targeted deep-core exercise. With the right approach, most women see meaningful improvement within **3–6 months**.",
    p1: "This guide covers what diastasis recti actually is, how to check for it at home, which exercises to avoid, which movements help rebuild the connective tissue, and when to see a specialist."
  },
  whatIsIt: {
    title: "What Is Diastasis Recti?",
    p1: "To understand Diastasis Recti (DR), we first need to talk about the 'linea alba.' Think of it as a thick, fibrous band of connective tissue that runs right down the middle of your six-pack muscles. During pregnancy, this tissue softens and stretches to allow your abdominal muscles to move aside as your baby grows. It's a brilliant design, really. Without this stretching, there simply wouldn't be enough room for your uterus to expand.",
    p2: "And this is where it gets interesting. Diastasis recti isn't actually a 'tear' in the muscle, despite what some scary internet articles might say. Instead, it's an over-stretching and thinning of that connective tissue. Physically, your left and right abdominal muscles have moved further apart, leaving a gap where the tissue has lost its tension. What most people don't tell you is that the width of the gap is only half the story; the *depth* and the tension of that tissue matter just as much.",
    p3: "Here's an analogy we love: imagine a zip on a jacket that has come undone under pressure. The teeth of the zip (your muscles) are still there and perfectly functional, but the slider (the linea alba) has lost its ability to hold them tightly together. Healing isn't just about 'closing' the gap; it's about restoring the strength and tension of that slider so the whole system can work as one again. But what does that actually mean for you? It means we need to focus on building tension from the deep core rather than just pulling the surface muscles together."
  },
  canHealOnItsOwn: {
    title: "Can Diastasis Recti Heal On Its Own?",
    p1: "The honest answer is: partially, yes — but rarely completely. In the first 6–8 weeks postpartum, some natural narrowing occurs as the uterus shrinks back to its pre-pregnancy size and relaxin (the hormone that softened your connective tissue during pregnancy) gradually clears from your system. For women with mild separation of one to two finger-widths, this natural process is sometimes sufficient.",
    p2: "For moderate to significant separation, the gap width alone tells only half the story. What matters more is the tension of the linea alba — the connective tissue bridging the gap. Passive rest does not rebuild tissue tension. Without specific deep-core work, that tissue can remain soft and slack even as the visible gap narrows, leaving you unable to manage intra-abdominal pressure properly. This is why back pain, pelvic floor issues, and the persistent 'mum pooch' so often continue despite months of rest.",
    p3: "The research consensus is clear: targeted exercise — particularly deep-core breathing and transverse abdominis activation — significantly improves both gap width and tissue tension. Most women who follow a structured programme see meaningful improvement within 3–6 months, though full functional recovery often takes closer to 12 months."
  },
  howCommon: {
    title: "How Common Is Diastasis Recti?",
    p1: "If you're feeling self-conscious about your midsection, please take a deep breath. Studies suggest that up to 60% of women have some degree of diastasis recti in the immediate postpartum period. Some researchers even argue that *every* pregnant woman has some degree of separation by the third trimester. It is a completely normal physiological response to carrying a baby.",
    p2: "What we know from research is that while many 'gaps' will begin to close naturally in the first few weeks after birth, many do not. We shouldn't dismiss it as 'just part of being a mum,' but we definitely shouldn't panic about it either. Whether this is your first baby or your fourth, your body is navigating a massive transition. Normalising the conversation around DR helps us move away from shame and toward effective, science-backed recovery.",
  ...
  howToCheck: {
    ...
    p4: "If you notice a 'doming' or 'coning' effect—where the middle of your belly bulges out like a little ridge—that's a sign that your intra-abdominal pressure isn't being managed well. It's your body's way of saying, 'Hey, I can't handle this load yet!' Take note of these findings. They aren't a grade; they are just a starting point for your healing journey."
  },
  whatMakesItWorse: {
    title: "Exercises to Avoid With Diastasis Recti",
    p1: "Here's the thing: some of the most common 'core' exercises are actually the worst things you can do if you have DR. This is because they create massive amounts of intra-abdominal pressure that pushes *out* against that weakened linea alba. Imagine a balloon—if you squeeze the top and bottom, the air has to go somewhere, and it usually pushes out at the weakest point. In your body, that weakest point is the gap.",
    p2: "We highly recommend avoiding traditional crunches and sit-ups. These movements focus on the 'rectus abdominis' (the surface muscles) but they can actually force the gap wider if the deep core isn't strong enough to hold things together. Similarly, double leg raises—where you lie on your back and lift both legs—put an enormous strain on your lower back and core. If you see that 'doming' we talked about earlier, stop immediately. Your body is telling you the load is too high.",
  ...
  exercisesHelp: {
    ...
    p4: "We also love Bird Dogs and Glute Bridges. For Bird Dogs, get on your hands and knees. As you exhale, extend the opposite arm and leg. This one is brilliant for the 'back' part of your core. For Glute Bridges, lie on your back and lift your hips. This engages your posterior chain, which supports your core from behind. Remember: quality over quantity. Five slow, perfect reps are worth more than fifty rushed ones."
  },
  seePhysio: {
    title: "When Should You See a Women's Health Physiotherapist?",
    p1: "We are huge advocates for 'Women's Health Physiotherapy.' In many countries, a visit to a pelvic health physio is a standard part of postpartum care. Here in the UK, the <a href=\"https://pogp.csp.org.uk\" target=\"_blank\" rel=\"noopener noreferrer\">POGP physiotherapy guidelines</a> are very clear about the benefits of specialist assessment. Frame physio as the smart move, not the last resort. It's an investment in your long-term health, not just a fix for a current problem.",
  ...
  howLongHealing: {
    title: "How Long Does Diastasis Recti Take to Heal?",
    p1: "Genuine, functional healing of the connective tissue usually takes **6 months to a year** of consistent, correct exercise. Some women see significant shifts at 12 weeks; others are still making progress at the two-year mark. Both are entirely normal — and neither means you're doing it wrong.",
  ...
  faqs: [
    {
      ...
      a: "While some natural 'shrinking' happens in the first few weeks as the uterus returns to size, significant DR usually requires intentional exercise to restore tissue tension. Without specific deep-core work, the gap often remains and can lead to back pain or pelvic floor issues later in life. Based on <a href=\"https://www.nhs.uk\" target=\"_blank\" rel=\"noopener noreferrer\">NHS guidance</a>, supervised exercise is the gold standard for recovery."
    },
    {
      q: "Does everyone get diastasis recti after pregnancy?",
      a: "Almost everyone! Research shows nearly 100% of women have some degree of separation in the third trimester. It's a necessary part of making room for the baby. Whether it stays 'open' postpartum depends on genetics, the size of the baby, the number of pregnancies, and how you move in the early weeks after birth."
    },
    {
      q: "Can I do yoga or Pilates with diastasis recti?",
      a: "Yes, but with modifications. Many yoga poses like 'Upward Dog' or 'Plank' can be too intense for a healing core. Similarly, many Pilates 'ab' moves need to be scaled back. Look for instructors who are specifically trained in 'Pre and Postnatal' movement—they will know how to adjust the poses so you can reap the benefits without the risk."
    },
    {
      q: "Will a belly band or support garment help?",
      a: "A support garment can provide a wonderful 'sense of security' and help you move more comfortably in the early days. However, it is not a 'fix.' Think of it as a temporary splint. You still need to do the internal work to build your own 'internal corset.' Wearing one too long can actually make your muscles 'lazy,' so use it as a tool, not a crutch."
    },
    {
      q: "Can diastasis recti come back after healing?",
      a: "Yes, particularly with a subsequent pregnancy. If you heal your DR and then get pregnant again, the tissue will naturally stretch again. However, having done the work once makes the second recovery much faster because you already have the 'muscle memory' and the correct breathing patterns in place."
    }
  ],
  cta: {
