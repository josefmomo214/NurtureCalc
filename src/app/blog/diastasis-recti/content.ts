export const diastasisRectiContent = {
  ...
  howToCheck: {
    title: "How to Check Yourself at Home",
  ...
  whatMakesItWorse: {
    title: "What Makes Diastasis Recti Worse",
  ...
  startHealing: {
    title: "The Right Way to Start Healing",
  ...
  howLongHealing: {
    ...
    p3: "Be patient with yourself. You aren't 'fixing' a broken body; you're supporting a healing one. There will be days when you feel strong and days when you feel 'heavy.' What matters is the overall trend. Celebrate the small wins—like the first time you do a glute bridge and feel that 'firmness' in your midline. Those are the moments that tell you you're on the right track. You've got this, and we're cheering you on every step of the way."
  },
  faqs: [
    {
